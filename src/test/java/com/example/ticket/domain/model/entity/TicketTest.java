...
class TicketTest {
    ...
    void setUp() {
        ...
        ticket = new Ticket(ticketId, "テストチケット", "説明", Priority.MEDIUM, dueDate);
    }
    ...
    void 不正なステータス遷移の場合は例外が発生する() {
        assertThrows(InvalidStatusTransitionException.class, () ->
            ticket.changeStatus(Status.RESOLVED)
        );
    }
